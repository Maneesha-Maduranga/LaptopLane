  ...
  return (
    <>
      ...
      <div
        className={
          showFillter
            ? `fixed top-0 right-0  overflow-y-auto shadow-xl bg-white z-20 ease-in-out duration-500`
      ...
      <div className='container mx-auto px-4'>
        {/* Top section */}
        <div className='flex items-center justify-between border-b border-gray-200 pb-4 pt-10 my-4'>
          <div className='flex'>
